...
import { getPermissionModeCycleShortcut } from '@cli/utils/terminal/permissionModeCycleShortcut'
import { getCwd } from '@utils/state'
import { CompactModeIndicator } from '@components/ModeIndicator'
import { getPromptInputSpecialKeyAction } from '@cli/utils/terminal/promptInputSpecialKey'
      ...
      {!completionActive && suggestions.length === 0 && (
        <Box flexDirection="column" paddingX={2} paddingY={0}>
          ...
          <Box flexDirection="row" justifyContent="space-between">
            <Box flexDirection="column" justifyContent="flex-start" gap={1}>
              {currentMode !== 'default' ? <CompactModeIndicator /> : null}
              {exitMessage.show ? (
