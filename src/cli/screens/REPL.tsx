...
import { clearTerminal, updateTerminalTitle } from '@cli/utils/terminal'
...
import { createToolUiBridge } from '@cli/utils/toolUiBridge'
    ...
    if (newMessages.length) {
      ...
      for await (const message of query(
        ...
        canUseTool,
        {
          ...
          readFileTimestamps: readFileTimestamps.current,
          abortController: newAbortController,
          ui: createToolUiBridge({ setToolJSX, setToolUseConfirm }),
        },
